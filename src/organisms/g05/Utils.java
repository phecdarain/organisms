...
public class Utils implements Player {
	...
	public static int[] dirMap = {NORTH,WEST,SOUTH,EAST};
	
	public static int localNORTH = 0;
	public static int localWEST = 1;
	public static int localSOUTH = 2;
	public static int localEAST = 3;
